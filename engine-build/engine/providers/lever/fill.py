...
# has ONE home -- greenhouse.resolve_values -- and Lever delegates to it rather
...
def resolve_values(fieldmap: FieldMap, ssot, profile: dict, *,
    ...
    purely on the FORM's structure, so it is correct for a DOM-captured Lever
    field map exactly as for a schema-captured Greenhouse one."""
